       ...
       <div  className='full-Page-Image' style={{top:0,position:'relative',backgroundImage:`url(${FlightImage})`
        ...
        <div style={{position:'relative',left:150}}>
          ...
          <div style={{position:'relative',left:150,top:-80}}>
            ...
            <div style={{position:'relative',left:150,top:-163}}>
                <h4>Enter Fight Id</h4>
            </div>
            <input style={{position:'relative',backgroundColor:'transparent',width:200,height:20,textAlign:'center',left:140,
            top:-180
            ,borderRadius:'10px',fontSize:'17x'}}
        ...
        <Button type='submit' style={{position:"relative",backgroundColor:'green',color:'black',top:-130,left:-10,height:30,fontSize:12}}  data-testid="submit" onClick={()=>{
var updateFlight={
...
axios.patch(`http://localhost:8081/flights/updateFlight`,updateFlight).then((res)=>{
